...
import { Loader2, Save, Leaf, ArrowLeft, Instagram } from 'lucide-react';
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure the gallery page settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label>Page Title</Label>
                <Input value={formData.heroTitle} onChange={(e) => setFormData({ ...formData, heroTitle: e.target.value })} placeholder="Enter page title" />
              </div>
              <div className="space-y-2">
